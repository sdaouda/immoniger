...
class Product(models.Model):
    ...
    image = models.ImageField(upload_to='immo/%Y/%m/%d', blank=True,null=True)
    image1 = models.ImageField(upload_to='immo/%Y/%m/%d', blank=True,null=True)
    image2 = models.ImageField(upload_to='immo/%Y/%m/%d', blank=True,null=True)
    image3 = models.ImageField(upload_to='immo/%Y/%m/%d', blank=True,null=True)
    #image4 = models.ImageField(upload_to='products/imgs/', blank=True,null=True)
    image4 = models.ImageField(upload_to='immo/%Y/%m/%d', blank=True,null=True)
    image5 = models.ImageField(upload_to='immo/%Y/%m/%d', blank=True,null=True)
